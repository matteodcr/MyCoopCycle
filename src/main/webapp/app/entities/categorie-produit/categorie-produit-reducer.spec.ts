...
import reducer, {
  ...
  partialUpdateEntity,
  reset,
} from './categorie-produit.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CATEGORIEPRODUIT_LIST actions', async () => {
    ...
    it('dispatches FETCH_CATEGORIEPRODUIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CATEGORIEPRODUIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CATEGORIEPRODUIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CATEGORIEPRODUIT actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CATEGORIEPRODUIT actions', async () => {
      const expectedActions = [
        {
