...
import com.mycoopcycle.service.mapper.ProduitMapper;
...
class ProduitResourceIT {
    ...
    public static Produit createEntity(EntityManager em) {
        Produit produit = new Produit().name(DEFAULT_NAME);
        return produit;
    }
    ...
    public static Produit createUpdatedEntity(EntityManager em) {
        Produit produit = new Produit().name(UPDATED_NAME);
        return produit;
    }
    ...
    void putExistingProduit() throws Exception {
        ...
        updatedProduit.name(UPDATED_NAME);
