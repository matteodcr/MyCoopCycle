...
import static com.mycoopcycle.web.rest.TestUtil.sameNumber;
...
class ItemResourceIT {
    ...
    public static Item createEntity(EntityManager em) {
        Item item = new Item().prix(DEFAULT_PRIX);
        return item;
    }
    ...
    public static Item createUpdatedEntity(EntityManager em) {
        Item item = new Item().prix(UPDATED_PRIX);
        return item;
    }
    ...
    void createItem() throws Exception {
        ...
        assertThat(testItem.getPrix()).isEqualByComparingTo(DEFAULT_PRIX);
    }
    ...
    void putExistingItem() throws Exception {
        ...
        Item testItem = itemList.get(itemList.size() - 1);
        assertThat(testItem.getPrix()).isEqualByComparingTo(UPDATED_PRIX);
    }
    ...
    void fullUpdateItemWithPatch() throws Exception {
        ...
        partialUpdatedItem.prix(UPDATED_PRIX);
