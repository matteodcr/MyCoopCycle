package myccopcycle.web.rest;

import static myccopcycle.test.util.OAuth2TestUtil.TEST_USER_LOGIN;
import static myccopcycle.test.util.OAuth2TestUtil.registerAuthenticationToken;
import static myccopcycle.test.util.OAuth2TestUtil.testAuthenticationToken;
import static org.springframework.test.web.servlet.request.MockMvcRequestBuilders.get;
import static org.springframework.test.web.servlet.result.MockMvcResultMatchers.*;

import myccopcycle.IntegrationTest;
import myccopcycle.security.AuthoritiesConstants;
